        ...
        <div class="thumbnail" >
            ...
            <div class="row" style="margin-left: 0px; margin-right: 0px;width: auto;">
                <div class="ratings" style="text-align: center">
                    <a href="ofertaexibida.php?oferta=<?php echo $id; ?>" style="color: #333333">  <button type="button" class="btn btn-primary" style="width:100%"><?php echo utf8_decode("PEGAR CUPOM GRÁTIS"); ?></button></a>
                </div>
            </div>
            <div class="row" style="margin-left: 0px; margin-right: 0px;width: auto;">
