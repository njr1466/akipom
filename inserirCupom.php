                                    ...
                                    <div class="section">
                                        <div class="container">
                                            ...
                                            <table class="table-responsive">
                                                <tr>
                                                    <td style="padding: 2px"><button type="button" class="btn btn-primary right" onclick="cont();" >IMPRIMIR CUPOM</button></td>
                                                    <td><button type="button" class="btn btn-primary right" style="float: left;">INDICAR À UM AMIGO</button> </td>
                                                </tr>
                                            </table>
                                            </div>
                                        </div>
                                        ...
                                        <div class="section">
                                            <div class="container">
                                                <div class="row" >
                                                    <table  class="table-responsive">
                                                        <tr>
                                                            <td> <img src="imagem/LOGO.png" class="img-responsive" style="float:right;"></td>
                                        ...
                                        <div class="section">
                                            <div class="container">
                                                <div class="row" >
                                                    ...
                                                    <table>
                                                        <tr>  <img src="imagem/fotos/<?php echo $oferta->foto1; ?>" class="img-responsive" >
