...
<div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input id="promocaocompleta"  name="promocaocompleta" type="text" placeholder="Digite o nome da promoção" class="form-control input-md" required="">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input id="observacao" name="observacao" type="text" placeholder="Digite alguma observação" class="form-control input-md" required="">
