                                            ...
                                            <form  id="formoferta" enctype="multipart/form-data" action="leoferta.php" method="post">
                                                <div class="panel panel-default">
                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            <label class="col-md-4 control-label" for="promocao">Promoção Resumida</label>  
                                                            <div class="col-md-8">
                                                           ...
                                                           <div class="form-group">
                                                            <label class="col-md-4 control-label" for="promocaocompleta">Promoção Completa</label>  
                                                            <div class="col-md-8">
                                                                <input id="promocaocompleta" name="promocaocompleta" type="text" placeholder="Digite o nome da promoção��o" class="form-control input-md" required="" value="<?php echo $resultado->promocaocompleta; ?>">
...
<input name="mapaonly" type="text" readonly="readonly" value="<?= $resultado->mapa;?>">
                                                        ...
                                                        <label class="col-md-4 control-label" for="observacao">Observação</label>  
                                                            <div class="col-md-8">
                                                                <input id="observacao" name="observacao" type="text" placeholder="Digite a observação" class="form-control input-md" required="" value="<?php echo $resultado->observacao; ?>">
