...
$resultado = DAOFactory::getBannersuperiorDAO()->load($_GET['codigo']);
...
<script type="text/javascript">bkLib.onDomLoaded(nicEditors.allTextAreas);</script>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="panel-group" id="accordion">
                                            <form  id="formoferta" enctype="multipart/form-data" action="leBannerSuperior.php" method="post">
                                                <div class="panel panel-default">
                                                    <input name="action" type="hidden" value="edit">
                                                    <input name="id" type="hidden" value="<?php echo $_GET['codigo'];?>">
                                                    <div class="panel-heading">
                                                        <div class="btn-group btn-group-justified">
                                                            <a href="addBannerSuperior.php.php" class="btn btn-primary col-sm-3">
                                                                <i class="glyphicon glyphicon-plus"></i>
                                                                <br> Adicionar
                                                            </a>

                                                            <a href="bannersuperior.php" class="btn btn-primary col-sm-3">
  ...
  <!-- Text input-->
                                                        <div class="form-group">
                                                            <label class="col-md-4 control-label" for="texto1">Descrição 1</label>  
                                                            <div class="col-md-8">
                                                                <input id="texto1" name="texto1" value="<?php echo $texto1;?>" type="text" placeholder="Digite a data inicial da oferta" class="form-control input-md" required="">
                                                        ...
                                                        <!-- Text input-->
                                                        <div class="form-group">
                                                            <label class="col-md-4 control-label" for="texto2">Descrição 2</label>  
                                                            <div class="col-md-8">
                                                                <input id="texto2" name="texto2" type="text"  value="<?php echo $texto2;?>" placeholder="Digite a data inicial da oferta" class="form-control input-md" required="">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-12">
                                                                <img src="../imagem/bannersuperior/<?php echo $resultado->imagem;?>" style="width:20%">
