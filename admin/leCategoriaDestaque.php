...
if (isset($_GET['acao'])) {
    $id = $_GET['codigo'];
    DAOFactory::getCategoriadestaqueDAO()->delete($id);
...
if ($action == "add") {
    try {
        ...
        $id = DAOFactory::getCategoriadestaqueDAO()->insert($categoriaDestaque);
        $transaction->commit();
        echo"<meta http-equiv='refresh' content=3;url='addCategoriaDestaque.php'>";
    } catch (Exception $exc) {
