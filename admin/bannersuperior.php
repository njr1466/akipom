...
<html>
    ...
    <script>
        function myFunction(id) {
            ...
            if (answer) {
                window.location = "leBannerSuperior.php?acao=deletar&codigo=" + id + "";
            }
            else {
                alert("Obrigado")
            }
                                        ...
                                        <div class="well"><div class="btn-group btn-group-justified">
                                            ...
                                            <table class="table table-striped custab">
                                                ...
                                                for ($i = 0; $i < $count; $i++) {
                                                    ...
                                                    <tr>
                                                        <td> <?php echo $id1; ?></td>
                                                        <td><img src="../imagem/bannersuperior/<?php echo $imagem ?>" style="width: 400px;height: 60px"></td>
                                                        <td><?php echo $datainicial; ?></td>
                                                        <td><?php echo $datafinal; ?></td>
                                                        <td class="text-center"><a class='btn btn-info btn-xs' href="editbannersuperior.php?codigo=<?php echo $id1; ?>"><span class="glyphicon glyphicon-pencil"></span> Editar</a> <a href="#" class="btn btn-danger btn-xs" onclick="myFunction(<?php echo $id1; ?>)"><span class="glyphicon glyphicon-remove" ></span> Excluir</a></td>
                                                    </tr>
                                                    <?php
                                                }
                                                ?>
