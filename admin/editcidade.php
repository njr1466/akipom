																...
																<input name="id" type="hidden" value="<?php echo $_GET['codigo'];?>">
																	<div class="col-md-12">
																		<div class="form-group">
																			<input name="nome" type="text" class="form-control" placeholder="Cidade" required="" value="<?php echo $nome;?>">
																		</div>
																		<div class="form-group">
																			<textarea name="uf" class="form-control" placeholder="uf" rows="5" required="" ><?php echo $descricao;?></textarea>
																		</div>
																	</div>
																</div>
																<div class="form-group">
