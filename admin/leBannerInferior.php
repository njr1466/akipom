...
if (isset($_GET['acao'])) {
    $id = $_GET['codigo'];
    DAOFactory::getBannerinferiorDAO()->delete($id);
...
$uploaddir = '../imagem/bannerinferior/';
$nome = rand(00, 9999);
...
if ($action == "add") {
    try {
        ...
        $id = DAOFactory::getBannerinferiorDAO()->insert($Bannerinferior);
        $transaction->commit();
        echo"<meta http-equiv='refresh' content=3;url='addBannerInferior.php'>";
    } catch (Exception $exc) {
