...
<html>
    ...
    <script>
        function myFunction(id) {
            ...
            if (answer) {
                window.location = "leCategoriaDestaque.php?acao=deletar&codigo=" + id + "";
            }
            else {
                alert("Obrigado")
            }
                                ...
                                <div class="row">
                                    ...
                                    <div class="container">
                                        <div class="well"><div class="btn-group btn-group-justified">
                                                ...
                                                <a href="categoriaDestaque.php.php" class="btn btn-primary col-sm-3">
                                            ...
                                            <table class="table table-striped custab">
                                                ...
                                                for ($i = 0; $i < $count; $i++) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><img src="../imagem/<?php echo $imagem ?>" style="width: 100px;height: 60px"></td>
                                                        <td><?php echo $texto; ?></td>
                                                        <td><?php echo $link; ?></td>
                                                        <td class="text-center"><a class='btn btn-info btn-xs' href="editcategoriadestaque.php?codigo=<?php echo $id1; ?>"><span class="glyphicon glyphicon-pencil"></span> Editar</a> <a href="#" class="btn btn-danger btn-xs" onclick="myFunction(<?php echo $id1; ?>)"><span class="glyphicon glyphicon-remove" ></span> Excluir</a></td>
                                                    </tr>
                                                    <?php
                                                }
                                                ?>
