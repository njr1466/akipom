                                                ...
                                                <div class="panel panel-default">
                                                    ...
                                                    <div class="panel-heading">
                                                        <div class="btn-group btn-group-justified">
                                                            <a href="addBannerSuperior.php" class="btn btn-primary col-sm-3">
                                                    ...
                                                    <fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input id="texto1" name="texto1" type="text" placeholder="Digite a data inicial da oferta" class="form-control input-md" required="">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-md-8">
                                                                <input id="texto2" name="texto2" type="text" placeholder="Digite a data inicial da oferta" class="form-control input-md" required="">
